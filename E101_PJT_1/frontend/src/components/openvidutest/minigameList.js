...
export const minigameList = [
  ...
  ['전 애인과 추억의 물건', 30, 1, "추억은 독이기도 하겠지,,, 물건을 가져와라"],
  ...
  ['우물에 가서 __ ___', 3, 1, "오래된 말이 가지는 힘이 있다. 다음 속담의 부분을 보고 속담을 완성하라."],
  ['낮 말은 새가 듣고 _ __ __ ___', 3, 1, "오래된 말이 가지는 힘이 있다. 다음 속담의 부분을 보고 속담을 완성하라."],
  ['남의 집 잔치에 _ __ _ __ __', 3, 1, "오래된 말이 가지는 힘이 있다. 다음 속담의 부분을 보고 속담을 완성해라."],
  ['언 발에 ____', 3, 1, "오래된 말이 가지는 힘이 있다. 다음 속담의 부분을 보고 속담을 완성해라."],
  ['달면 삼키고 __ ___', 3, 1, "오래된 말이 가지는 힘이 있다. 다음 속담의 부분을 보고 속담을 완성해라."],
  ['비 온 뒤에 __ ___', 3, 1, "오래된 말이 가지는 힘이 있다. 다음 속담의 부분을 보고 속담을 완성하라."],
  // 210개 ======================================
  ['말은 해야 맛이고 ___ ___ ___', 3, 1, "오래된 말이 가지는 힘이 있다. 다음 속담의 부분을 보고 속담을 완성하라."],
  ['누워서 ___', 3, 1, "오래된 말이 가지는 힘이 있다. 다음 속담의 부분을 보고 속담을 완성해라."],
  ['같은 값이면 ____', 3, 1, "오래된 말이 가지는 힘이 있다. 다음 속담의 부분을 보고 속담을 완성해라."],
  ['못된 송아지 ____ ___', 3, 1, "오래된 말이 가지는 힘이 있다. 다음 속담의 부분을 보고 속담을 완성하라."],
